...
E["pr10"] = {"type": "code", "xp": 5, "minLines": 8,
    ...
    "answer": b64(pr10),
    "answerNote": "abs(1.0 - 1.01) is 0.010000000000000009 in floating point, so the boundary case prints Different either way; the strict < is still the right operator."}
