...
E["c7"] = {"type": "code", "xp": 5, "minLines": 7,
    ...
    "answer": b64(c7)}
c8 = ("amount_due = int(input('Amount due (cents): '))\namount_paid = int(input('Amount paid (cents): '))\nchange = amount_paid - amount_due\n\n"
      "toonies = change // 200\nchange = change % 200\nloonies = change // 100\nchange = change % 100\nquarters = change // 25\nchange = change % 25\n"
      "dimes = change // 10\nchange = change % 10\nnickels = change // 5\ncents = change % 5\n\n"
      "print(f'Toonies: {toonies}')\nprint(f'Loonies: {loonies}')\nprint(f'Quarters: {quarters}')\nprint(f'Dimes: {dimes}')\nprint(f'Nickels: {nickels}')\nprint(f'Cents: {cents}')\n")
E["c8"] = {"type": "code", "xp": 10, "minLines": 16, "maxLines": 30,
    "starter": "amount_due = int(input('Amount due (cents): '))\namount_paid = int(input('Amount paid (cents): '))\nchange = amount_paid - amount_due\n\ntoonies = change // 200\nchange = change % 200\n\n# Continue with loonies, quarters, dimes, nickels, and cents.\n",
    "cases": [case("Typed 326 and 500", ["326", "500"], c8), case("Typed 1 and 1000", ["1", "1000"], c8), case("Typed 250 and 250", ["250", "250"], c8)],
    "check": 'assert "for " not in __source__ and "while " not in __source__, "Do not use a loop: use integer division and remainder for each coin."',
    "answer": b64(c8)}
